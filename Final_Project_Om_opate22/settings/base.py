...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "dishes.context_processors.user_location",
            ],
        },
    },
]
...
# Session Settings - Sign out when browser closes
SESSION_EXPIRE_AT_BROWSER_CLOSE = True
SESSION_COOKIE_AGE = 86400  # 24 hours (backup in case browser doesn't close properly)
